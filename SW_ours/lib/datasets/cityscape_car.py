...
class cityscape_car(imdb):
    def __init__(self, image_set, devkit_path=None):
        ...
        # self._devkit_path = cfg_d.CITYSCAPE_CAR#self._get_default_path() if devkit_path is None \
            #else devkit_path
        self._devkit_path = (
            self._get_default_path() if devkit_path is not None else devkit_path
        )
    ...
    def _do_python_eval(self, output_dir="output"):
        ...
        imagesetfile = os.path.join(
            self._devkit_path, "VOC2007","ImageSets", "Main", self._image_set + ".txt"
        )
        cachedir = os.path.join(self._devkit_path, "annotations_cache")
        # cachedir = '/home/amax/goulijun/CR-DA-DET/SW_Faster_ICR_CCR/data/cityscape/VOC2007/ImageSets/Main'
        aps = []
