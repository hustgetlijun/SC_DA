...
from model.da_faster_rcnn_allover.DA import _InstanceDA
...
class _fasterRCNN(nn.Module):
    ...
    def forward(
        ...
        # print('pix object shape is:',pix_object.size())
        # print('base feat1 shape is:',base_feat1.size())

        base_object_feat = torch.cat((base_feat1, F.sigmoid(pix_object).detach()), dim=1)

        windows = get_receptive_field_feature(base_feat1,im_data,(40,40),4)  #VGG16

        windows = get_receptive_field_feature(base_feat1, im_data, (35, 35), 4)  # renet101
        ...
        # print('object_feat shape is:',object_feat.size())
        # print('object_label shape is:',object_label.size())
        ...
        if target:
            ...
            return d_pixel,domain_pix_mid, domain_p
    ...
    def _init_weights(self):
        ...
        # normal_init(self.object_pre, 0, 0.01, cfg.TRAIN.TRUNCATED)
        # normal_init(self.classs_pre, 0, 0.01, cfg.TRAIN.TRUNCATED)

    def create_architecture(self):
        self._init_modules()
        self._init_weights()
        # self.object_pre._init_weights()
        # self.classs_pre._init_weights()
