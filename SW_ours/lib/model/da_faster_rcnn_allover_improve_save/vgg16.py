...
from model.da_faster_rcnn_allover.faster_rcnn import _fasterRCNN
...
class vgg16(_fasterRCNN):
    def __init__(
        ...
        _fasterRCNN.__init__(self, classes, class_agnostic, self.lc, self.gc,self.da_use_contex)
    ...
    def _init_modules(self):
        ...
        self.netD_pixel_mid = netD_pixel_mid(self.n_classes-1,context=self.gc)
