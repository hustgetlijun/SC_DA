...
from model.da_faster_rcnn_allover_improve.faster_rcnn import _fasterRCNN
...
class resnet(_fasterRCNN):
    ...
    def _init_modules(self):
        ...
        self.RCNN_base_mid = nn.Sequential(resnet.layer2)
        self.RCNN_base2 = nn.Sequential(resnet.layer3)
        ...
        self.RCNN_base_mid.apply(set_bn_fix)
    ...
    def train(self, mode=True):
        ...
        if mode:
            ...
            self.RCNN_base_mid.apply(set_bn_eval)
