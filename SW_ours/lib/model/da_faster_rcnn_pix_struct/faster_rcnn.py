...
from model.da_faster_rcnn_pix_struct.DA import _InstanceDA
...
class _fasterRCNN(nn.Module):
    ...
    def forward(
        ...
        # b,c,h,w = im_data.size()
        # print('image size is :',im_data.size())

        im_info = im_info.data
        gt_boxes = gt_boxes.data
        num_boxes = num_boxes.data
        # print('gt boxes is :',gt_boxes.size())
        ...
        # cls_feat = F.relu(self.pix_pre_Conv(base_feat))

        # print('cls feat shape1 is:', cls_feat)
        # cls_feat = cls_feat.squeeze(-1).squeeze(-1)

        # print('cls feat shape2 is:',cls_feat)
        ...
        # print('-----------pooling model is :', cfg.POOLING_MODE)
