...
start_epoch = 12
max_epochs = 12
output_dir = "./data/experiments/SW_Faster_ICR_CCR/clipart/model"
dataset = "clipart"

for i in range(start_epoch, max_epochs + 1):
    model_dir = "./data/experiments/SW_Faster_ICR_CCR/clipart/model_result/model_allover_all/ours/clipart_391.pth".format(
        i
    )
