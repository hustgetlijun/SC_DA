...
from model.da_faster_rcnn_GLJ.resnet import resnet
from model.da_faster_rcnn_GLJ.vgg16_0 import vgg16
...
if __name__ == "__main__":
    ...
    # print('faster rcnn sturcture is :',fasterRCNN)
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            pix_label.data.resize_(data_s[5].size()).copy_(data_s[5])
            ...
            pix_label.data.resize_(data_t[5].size()).copy_(data_t[5])
