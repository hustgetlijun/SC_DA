#!/bin/bash
save_dir="./data/experiments/SW_Faster_ICR_CCR/sim10k/all_ours_net_2"
dataset="sim10k"
pretrained_path="./pretrained/vgg16_caffe.pth"
net="vgg16"

CUDA_VISIBLE_DEVICES=2 python da_train_net_overall.py --max_epochs 12 --cuda --dataset ${dataset} --net ${net} --save_dir ${save_dir} --pretrained_path ${pretrained_path} --gc --lc --da_use_contex
