...
if __name__ == "__main__":
    ...
    if args.dataset == "pascal_voc":
        ...
        print("loading our dataset...........")
        args.s_imdb_name = "Carton_2007_train_G_ECLC"
        args.t_imdb_name = "Carton_2007_train_FM"
        args.s_imdbtest_name = "Carton_2007_test_ECLC"
        args.t_imdbtest_name = "Carton_2007_test_FM"
        args.set_cfgs = [
            "ANCHOR_SCALES",
            "[8,16,32]",
            "ANCHOR_RATIOS",
    ...
    print("source {:d} roidb entries".format(len(s_roidb)))
