...
save_dir="./data/experiment/Faster_ori/cityscape/train"
dataset="cityscape"
pretrained_path="./pretrained/vgg16_caffe.pth"
net="vgg16"

CUDA_VISIBLE_DEVICES=1 python faster_train_net.py --max_epochs 6 --cuda --dataset ${dataset} --net ${net} --save_dir ${save_dir} --pretrained_path ${pretrained_path} 
