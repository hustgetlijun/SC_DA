...
from model.da_faster_rcnn_change_test.resnet import resnet
from model.da_faster_rcnn_change_test.vgg16 import vgg16
...
if __name__ == "__main__":
    ...
    for i in range(num_images):
        ...
        pix_label.resize_(data[5].size()).copy_(data[5])
