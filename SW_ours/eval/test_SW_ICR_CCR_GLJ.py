...
if __name__ == "__main__":
    ...
    if args.net == "vgg16":
        ...
        pdb.set_trace()
    # print('faster rcnn structure is :',fasterRCNN)
    ...
    for i in range(num_images):
        ...
        lable_pix.data.resize_(data[5].size()).copy_(data[5])
        ...
        with torch.no_grad():
            (
                ...
                domain_p,
                DA_ins_loss_cls,
            ) = fasterRCNN(im_data, im_info, im_cls_lb, gt_boxes, num_boxes,lable_pix,)
