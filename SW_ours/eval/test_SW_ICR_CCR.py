...
def parse_args():
    ...
    parser.add_argument(
        "--parallel_type",
        dest="parallel_type",
        help="which part tmux new -sof model to parallel, 0: all, 1: model before roi pooling",
        default=0,
        type=int,
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    #   'faster_rcnn_{}_{}_{}.pth'.fortmux new -smat(args.checksession, args.checkepoch, args.checkpoint))
