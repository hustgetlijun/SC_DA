...
from model.da_faster_rcnn_pix_struct.resnet import resnet
from model.da_faster_rcnn_pix_struct.vgg16 import vgg16
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            if step % args.disp_interval == 0:
                ...
                print(
                    "\t\t\tloss_category_cls: %.4f, rpn_cls: %.4f, rpn_box: %.4f, rcnn_cls: %.4f, rcnn_box %.4f dloss s: %.4f dloss t: %.4f dloss s pixel: %.4f dloss t pixel: %.4f eta: %.4f"
                    % (
                        loss_category_cls,
                        loss_rpn_cls,
                        loss_rpn_box,
