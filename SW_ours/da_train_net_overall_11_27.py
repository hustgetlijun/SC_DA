...
if __name__ == "__main__":
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            loss = (
                0.5*category_loss_cls  #* args.eta
                + rpn_loss_cls.mean()
                + rpn_loss_box.mean()
                + RCNN_loss_cls.mean()
                + RCNN_loss_bbox.mean()
                + 0.5*object_loss.mean() #* args.eta
                + 0.5*mid_class_loss.mean() #* args.eta
            ...
            c1,c2,c3,out_d_pixel,out_d_pixel_mid, out_d,target_ins_da,pix_weight,pix_mid_weight,category_consistency_loss_T = fasterRCNN(
                im_data,
                im_info,
                im_cls_lb,
                gt_boxes,
            ...
            ####################################
            loss += 0.5*(c1+c2+c3)
            category_consistency_loss = (category_consistency_loss_S+category_consistency_loss_T)
            # category_consistency_loss = category_consistency_loss_S
            loss += category_consistency_loss.mean()
            ####################################
            ...
            if args.dataset == "sim10k":
                ...
                loss += dloss_s + dloss_t + dloss_s_p + dloss_t_p+loss_t_mid_d+loss_s_mid_d
